				...
				<div class="span5">
					...
					<div class="social_icon">
						<ul class="clearfix">
							...
							<?php if(sketch_get_option($incart_lite_shortname.'_vk_link')){ ?><li class="vk-icon"><a target="_blank" href="<?php echo esc_url(sketch_get_option($incart_lite_shortname.'_vk_link','incart-lite')); ?>"><span class="fa fa-vk" title="vk"></span></a></li><?php } ?>
							<?php if(sketch_get_option($incart_lite_shortname.'_skype_link')){ ?><li class="skype-icon"><a target="_blank" href="<?php echo esc_url(sketch_get_option($incart_lite_shortname.'_skype_link','incart-lite')); ?>"><span class="fa fa-skype" title="skype"></span></a></li><?php } ?>
							<?php if(sketch_get_option($incart_lite_shortname.'_instagram_link')){ ?><li class="instagram-icon"><a target="_blank" href="<?php echo esc_url(sketch_get_option($incart_lite_shortname.'_instagram_link','incart-lite')); ?>"><span class="fa fa-instagram" title="instagram"></span></a></li><?php } ?>
							<?php if(sketch_get_option($incart_lite_shortname.'_vimeo_link')){ ?><li class="vimeo-icon"><a target="_blank" href="<?php echo esc_url(sketch_get_option($incart_lite_shortname.'_vimeo_link','incart-lite')); ?>"><span class="fa fa-vimeo" title="vimeo"></a></li><?php } ?>
						</ul>
					</div>
					<!-- Social Links Section -->
				</div>
