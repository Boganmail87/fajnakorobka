...
global $incart_lite_shortname;
  ...
  $custom_settings = array(
    'contextual_help' => array(
		...
		array(
			'label'       => __('Vk Link','incart-lite'),
			'id'          => $incart_lite_shortname.'_vk_link',
			'type'        => 'text',
			'desc'        => __('Enter vk link.','incart-lite'),
			'std'         => '#',
			'condition'   => $incart_lite_shortname.'_head_topbar:is(on)',
			'section'     => 'head_topbar_settings'
		),
		array(
			'label'       => __('Skype Link','incart-lite'),
			'id'          => $incart_lite_shortname.'_skype_link',
			'type'        => 'text',
			'desc'        => __('Enter skype link.','incart-lite'),
			'std'         => '#',
			'condition'   => $incart_lite_shortname.'_head_topbar:is(on)',
			'section'     => 'head_topbar_settings'
		),
		array(
			'label'       => __('Instagram Link','incart-lite'),
			'id'          => $incart_lite_shortname.'_instagram_link',
			'type'        => 'text',
			'desc'        => __('Enter instagram link.','incart-lite'),
			'std'         => '#',
			'condition'   => $incart_lite_shortname.'_head_topbar:is(on)',
			'section'     => 'head_topbar_settings'
		),
		array(
			'label'       => __('Vimeo Link','incart-lite'),
			'id'          => $incart_lite_shortname.'_vimeo_link',
			'type'        => 'text',
			'desc'        => __('Enter vimeo link.','incart-lite'),
			'std'         => '#',
			'condition'   => $incart_lite_shortname.'_head_topbar:is(on)',
			'section'     => 'head_topbar_settings'
		),
