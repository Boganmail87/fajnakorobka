...
function incart_theme_stylesheet()
{
	...
	if ( !is_admin() ) 
	{
		...
		wp_enqueue_script('hoverIntent', get_template_directory_uri().'/js/hoverIntent.js',array('jquery'),true,'1.0');
		...
		/*GOOGLE FONTS*/
		wp_enqueue_style( 'google-Fonts-Roboto','//fonts.googleapis.com/css?family=Roboto:400,300,400italic,500,700', false, $theme->Version);
		wp_enqueue_style( 'google-Fonts-Lato','//fonts.googleapis.com/css?family=Lato:400,700', false, $theme->Version);
	}
}
